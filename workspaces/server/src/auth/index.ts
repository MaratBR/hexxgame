...
export function initPassport() {
    if (!koaPasswordReady) {
        ...
        koaPassport.serializeUser((user: User, done: (err: any, id?: string) => void) => done(null, user._id))
        koaPassport.deserializeUser(async (userId: string, done: (err: any, user?: User) => void) => {
